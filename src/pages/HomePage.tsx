      ...
      <Container fluid>
        ...
        <Row>
          ...
          <Col md={12} lg={8} className="BlueCard HomeCard">
            ...
            <div className="info">افضل مدرسة لتعليم في تصنيف العام الماضي</div>
            <div className="desc">
              نقدم لطفلك العديد من المزايا التي لا تستطيع المدارس العامة الوصول
              إليها وهنتقدم برضو مناهج متنوعة وطرق تدريس مبتكرة تعلم الطلاب
              كيفية تحقيق النجاح في عالم تتزايد فيه العولمة عشان يتخرج طفلك
              بمهارات أكاديمية قوية وتفكير نقدي ومهارات حل المشكلات و سيزود طفلك
              بالمنهج الدولي بالتعليم والمؤهلات المعترف بها عالميًا. و هنقدم
              العديد من الأنشطة ما بعد المدرسة بالإضافة إلى المنهج الأساسي، مثل
              الرياضة والموسيقى والرقص والتكنولوجيا وما إلى ذلك
            </div>
